...
using gAMSPro.MultiTenancy.HostDashboard;
...
namespace gAMSPro.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(gAMSProDbContext context, SubscriptionPayment subscriptionPayment)
        {
