...
using gAMSPro.Authorization.Users.Password;
...
using gAMSPro.Web.Startup.ExternalLoginInfoProviders;
...
namespace gAMSPro.Web.Startup
{
    ...
    public class gAMSProWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public gAMSProWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(gAMSProWebHostModule).GetAssembly());
        }
