...
namespace gAMSPro.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : gAMSProServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("gAMSPro", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
