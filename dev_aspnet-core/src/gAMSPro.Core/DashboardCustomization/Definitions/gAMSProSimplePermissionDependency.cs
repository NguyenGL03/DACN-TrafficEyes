...
namespace gAMSPro.DashboardCustomization.Definitions
{
    ...
    /// </summary>
    public class gAMSProSimplePermissionDependency : IPermissionDependency
    {
        /// <summary>
        ...
        /// </summary>
        public gAMSProSimplePermissionDependency()
        {
        ...
        public gAMSProSimplePermissionDependency(params string[] permissions)
        {
        ...
        /// </param>
        /// <param name="permissions">The permissions.</param>
        public gAMSProSimplePermissionDependency(bool requiresAll, params string[] permissions) : this(permissions)
        {
