...
using gAMSPro.Core.Base;
using gAMSPro.Core.Extensions;
using gAMSPro.Dto;
using gAMSPro.Types;

namespace gAMSPro.Queries
{
    public class OrganizationUnitQuery : gAMSProQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
