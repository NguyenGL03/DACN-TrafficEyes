...
using gAMSPro.EntityFrameworkCore.Repositories;

namespace gAMSPro.Organizations
{
    public class UserOrganizationUnitRepository : gAMSProRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<gAMSProDbContext> dbContextProvider)
