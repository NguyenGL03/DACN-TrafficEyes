...
{
    public class SubscriptionPaymentRepository : gAMSProRepositoryBase<SubscriptionPayment, long>,
        ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<gAMSProDbContext> dbContextProvider)
