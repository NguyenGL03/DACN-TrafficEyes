...
{
    public class UserRepository : gAMSProRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<gAMSProDbContext> dbContextProvider)
