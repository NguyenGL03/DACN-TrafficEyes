...
using gAMSPro.DashboardCustomization.Dto;

namespace gAMSPro.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : gAMSProAppServiceBase, IDashboardCustomizationAppService
    {
