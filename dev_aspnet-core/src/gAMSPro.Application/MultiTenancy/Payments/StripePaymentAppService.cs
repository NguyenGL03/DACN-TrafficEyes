...
using gAMSPro.MultiTenancy.Payments.Stripe;
using gAMSPro.MultiTenancy.Payments.Stripe.Dto;
using Stripe.Checkout;

namespace gAMSPro.MultiTenancy.Payments
{
    public class StripePaymentAppService : gAMSProAppServiceBase, IStripePaymentAppService
    {
                    ...
                    .Select(p => new SessionLineItemOptions
                    {
                        ...
                        PriceData = new SessionLineItemPriceDataOptions
                        {
                            ...
                            ProductData = new SessionLineItemPriceDataProductDataOptions
                            {
                                ...
                                Name = gAMSProConsts.ProductName
                            }
                        }
                    }).ToList();
            }
