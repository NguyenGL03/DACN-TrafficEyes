...
using gAMSPro.Authorization.Users.Profile.Cache;
...
{
    [AbpAuthorize]
    public class ProfileAppService : gAMSProAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("gAMSPro",
