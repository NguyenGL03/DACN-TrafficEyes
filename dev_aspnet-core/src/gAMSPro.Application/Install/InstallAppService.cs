...
namespace gAMSPro.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : gAMSProAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<gAMSProDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{gAMSProConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{gAMSProConsts.ConnectionStringName}", constring);
        }
