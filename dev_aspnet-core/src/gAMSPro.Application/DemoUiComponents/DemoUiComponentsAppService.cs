...
using gAMSPro.DemoUiComponents.Dto;

namespace gAMSPro.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : gAMSProAppServiceBase, IDemoUiComponentsAppService
    {
