...
using gAMSPro.Auditing.Exporting;
using gAMSPro.Authorization;
using gAMSPro.Authorization.Users;
using gAMSPro.Dto;
using gAMSPro.EntityHistory;
using EntityHistoryHelper = gAMSPro.EntityHistory.EntityHistoryHelper;

namespace gAMSPro.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : gAMSProAppServiceBase, IAuditLogAppService
    {
