...
using gAMSPro.Services.Navigation;
using Microsoft.AspNetCore.Components;
using gAMSPro.Mobile.MAUI.Services.Account;
using gAMSPro.Mobile.MAUI.Services.UI;
using Microsoft.JSInterop;
using gAMSPro.Mobile.MAUI.Services.Tenants;
using gAMSPro.Mobile.MAUI.Helpers;

#if ANDROID
using gAMSPro.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace gAMSPro.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new gAMSPro.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
