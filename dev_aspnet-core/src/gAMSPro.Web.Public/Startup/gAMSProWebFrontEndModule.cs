...
namespace gAMSPro.Web.Public.Startup
{
    [DependsOn(
        typeof(gAMSProWebCoreModule)
    )]
    public class gAMSProWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public gAMSProWebFrontEndModule(IWebHostEnvironment env, gAMSProEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(gAMSProWebFrontEndModule).GetAssembly());
        }
    }
}
