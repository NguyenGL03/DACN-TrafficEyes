...
using gAMSPro.Url;
using gAMSPro.Web.Public.Startup;
using gAMSPro.Web.Session;
using gAMSPro.Web.UiCustomization;

namespace gAMSPro.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : gAMSProViewComponent
    {
