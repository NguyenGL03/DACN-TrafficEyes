namespace gAMSPro.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_Administration_Menu_Search = "Pages.Administration.Menu.Search";
        public const string Pages_Administration_Menu_Create = "Pages.Administration.Menu.Create";
        public const string Pages_Administration_Menu_Edit = "Pages.Administration.Menu.Edit";
        public const string Pages_Administration_Menu_Delete = "Pages.Administration.Menu.Delete";
        public const string Pages_Administration_Menu_View = "Pages.Administration.Menu.View";
