        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        data: { permission: 'Pages.Administration.Editions' },
                    },
                    {
                        path: 'tenants',
                    ...
                    },
                    {
                        ...
                        data: { permission: 'Pages.Administration.Dashboard' },
                    },
                    {
                    ...
                    // {
                    //     path: 'uploadimage',
                    //     loadChildren: () => import('./uploadimages/uploadimages.module').then((m) => m.UploadImagesModule),
                    //     data: { permission: 'Pages.Administration.UploadImage' },
                    // }
                ]
            }
        ])
...
export class ZeroBaseRoutingModule { 
}
