...
export class AuditLogsComponent extends DefaultComponentBase implements AfterViewInit {
    ...
    getAuditLogs(event?: LazyLoadEvent) {
        ...
        this._auditLogService
            .getAuditLogs(
                moment(this.dateRange[0].toJSDate()),
                moment(this.dateRange[1].toJSDate().setHours(23, 59, 59)),
