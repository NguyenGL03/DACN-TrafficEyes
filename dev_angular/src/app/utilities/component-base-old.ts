...
import { EditableTableComponent } from '@app/shared/core/controls/editable-table/editable-table.component';
...
import { LocalizationService, PermissionCheckerService, FeatureCheckerService, NotifyService, SettingService, MessageService } from 'abp-ng2-module';
...
export abstract class ComponentBase {
    ...
    xlsRowsToArr(rows: IterableIterator<Array<Object>>, xlsStructure: Array<string>, getObject = function (obj) { return obj; }, clearWaiting = true, sliceNum: number = 0) {
        ...
        else if (curRow.value && xlsStructure.length != curRow.value.length) { // cau truc file import khong dung voi xlsStructure
