import { AfterViewChecked, ChangeDetectionStrategy, Component, EventEmitter, Injector, Input, OnInit, Output, ViewEncapsulation } from "@angular/core";
import { Vietnamese } from "./languages/flat-lan-vn";
...
@Component({
    ...
    templateUrl: './custom-flatpickr-time.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,

    providers: [createCustomInputControlValueAccessor(CustomFlatpickrTimeComponent)]
})
export class CustomFlatpickrTimeComponent extends ControlComponent implements OnInit, AfterViewChecked {
