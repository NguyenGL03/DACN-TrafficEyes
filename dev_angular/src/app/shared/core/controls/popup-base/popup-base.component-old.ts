import { AfterContentChecked, AfterViewChecked, AfterViewInit, Component, ElementRef, EventEmitter, Injector, Input, Output, ViewChild } from "@angular/core";
import { ListComponentBase } from "@app/utilities/list-component-base-old";
