...
import { FileUploaderEditableComponent } from './file-uploader-editable.component';

@Component({
    selector: "file-multi-modal-editable",
    templateUrl: "./file-multi-modal-editable.component.html",
    encapsulation: ViewEncapsulation.None
})
export class FileUploaderMultiModalEditableComponent extends ChangeDetectionComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    @Input() errors: string = '';
	fileUploader: FileUploaderEditableComponent;
    ...
    show(fileUploader: FileUploaderEditableComponent): void {
        this.errors = '';
