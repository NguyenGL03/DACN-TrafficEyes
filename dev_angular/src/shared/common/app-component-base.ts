...
export abstract class AppComponentBase implements OnDestroy {
    ...
    ls(sourcename: string, key: string, ...args: any[]): string {
        // console.log('SourceName:', sourcename, 'Key:', key);
    ...
    static loadingList: boolean[] = [];
    protected showLoading(): void {
        AppComponentBase.loadingList.push(true);
        console.log(AppComponentBase.loadingList)
        if (AppComponentBase.loadingList.some(loading => loading)) this.spinnerService.show();
        else this.spinnerService.hide();
    }

    protected hideLoading(): void {
        AppComponentBase.loadingList.pop(); 
        if (AppComponentBase.loadingList.some(loading => loading)) this.spinnerService.show();
        else this.spinnerService.hide();
    }
